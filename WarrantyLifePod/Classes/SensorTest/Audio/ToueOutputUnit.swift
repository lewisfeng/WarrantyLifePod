...
//  DiagnosticApp
//
//  Created by YI BIN FENG on 2021-09-05.
//  Copyright © 2021 cellairis. All rights reserved.
//
...
final class ToneOutputUnit: NSObject {
  ...
  var sampleRate : Double = 44100    // typical audio sample rate
  
  var f0  =    -1.0              // default frequency of tone:   'A' above Concert A
  var v0  =  16383.0 * 2              // default volume of tone:      half full scale
  ...
  func enableSpeaker() {
    guard !audioRunning else {
      print("\naudio is currently running, so just returned\n")
      return
    }
